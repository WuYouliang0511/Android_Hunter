package com.lotogram.ihunter.widget;//package com.wyl.ihunter.widget;
//
...
//
//public class PasswordEditTextaaaaa extends androidx.appcompat.widget.AppCompatEditText {
//
//    /**
//     * 默认的密码颜色
//     */
...
//
//    public PasswordEditTextaaaaa(Context context) {
//        this(context, null);
//    }
//
//    public PasswordEditTextaaaaa(Context context, AttributeSet attrs) {
//        super(context, attrs);
...
////        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.PasswordEditTextss);
////        // 密码的颜色
////        mPasswordColor = array.getColor(R.styleable.PasswordEditTextss_passwordColor, mPasswordColor);
////        // 密码圆点的半径
////        mPasswordRadius = (int) array.getDimension(R.styleable.PasswordEditTextss_passwordRadius,
////                dip2px(mPasswordRadius));
////        // 密码的个数
////        mPasswordNumber = array.getInteger(R.styleable.PasswordEditTextss_passwordNumber,
////                mPasswordNumber);
////
////        // 间隔线大小
////        mDivisionLineSize = (int) array.getDimension(R.styleable.PasswordEditTextss_divisionLineSize,
////                dip2px(mDivisionLineSize));
////        // 间隔线的颜色
////        mDivisionLineColor = array.getColor(R.styleable.PasswordEditTextss_divisionLineColor,
////                mDivisionLineColor);
////
////        // 边框的厚度
////        mBorderStrokeSize = (int) array.getDimension(R.styleable.PasswordEditTextss_bgSize, dip2px(
////                mBorderStrokeSize));
////        // 边框的圆角
////        mBorderCorner = (int) array.getDimension(R.styleable.PasswordEditTextss_bgCorner, 0);
////        // 获取边框的颜色
////        mBorderColor = array.getColor(R.styleable.PasswordEditTextss_bgColor, mBorderColor);
////
////        // 下划线的颜色
////        mUnderlineColor = array.getColor(R.styleable.PasswordEditTextss_underlineColor, mUnderlineColor);
////        // 下划线的厚度
////        mUnderlineSize = (int) array.getDimension(R.styleable.PasswordEditTextss_underlineSize,
////                dip2px(mUnderlineSize));
////
////        // 样式类型
////        mBgStyle = array.getInteger(R.styleable.PasswordEditTextss_bgStyle, BACKGROUND_STYLE_BORDER);
////        array.recycle();
////    }
//
////    /**
